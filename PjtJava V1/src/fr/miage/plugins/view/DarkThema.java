...
public class DarkThema implements IPluginView {
	...
	{
		JOptionPane.showMessageDialog(f, "Plugin de Vue DarkThema selectionné ! Poursuivre", "Plugin de vue", JOptionPane.INFORMATION_MESSAGE);
			...
			if(components[i].getName().equals("scrollPane"))
			{
				...
				for (int j=0; j<list.length; j++)
				{
					if(list[j].getName().equals("list"))
					{
						...
						list[j].setForeground(Color.decode("#e74c3c"));
