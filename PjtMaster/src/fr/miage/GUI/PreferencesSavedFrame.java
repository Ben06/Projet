...
public class PreferencesSavedFrame extends JFrame
{
	...
	public PreferencesSavedFrame()
	{
		...
		JFrame f = null ;
		JOptionPane.showMessageDialog(f, "Vos preferences ont été correctement sauvegardés pour une prochaine utilisation !", "ExploGin", JOptionPane.INFORMATION_MESSAGE);
